<?php
ob_start(); // e nis me bo output buffering
    session_start();

    $url = explode("/", $_SERVER['SCRIPT_FILENAME']);
    $file = end($url);
    $not_restricted_files = ['index.php', 'login.php', 'register.php'];

    if(!in_array($file, $not_restricted_files)) {
  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <div class="flex ml-2 md:mr-24">
          <img src="ice.png" class="h-8 mr-3" />
          <span class="self-center text-xl text-white font-semibold sm:text-2xl whitespace-nowrap dark:text-white"></span>
       </div>
      </div>
          ...
          <div class="flex items-center ml-3">
            <div>
              <button type="button" class="flex text-sm " aria-expanded="false" data-dropdown-toggle="dropdown-user">
                ...
                <img class="w-8 h-8" src="browser.png" alt="user photo">
              </button>
            </div>
            ...
            <div class="px-4 py-3" role="none">
                ...
                <?php if(!isset($_SESSION['isloggedin']) || ($_SESSION['isloggedin'] == false)): ?>
                    <li>
                    <a href="login.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Login</a>
                    </li>
                    <li>
                    <a href="register.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Register</a>
                    </li>
                    <?php else: ?>
                    <li>
                    ...
                    <li>
                    <a href="order.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Order</a>
                    </li>
                    <li>
                    <a href="edit_profile.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Edit Profile</a>
                    </li>
                    <?php if($_SESSION['role'] == 'admin'): ?>
                    <li>
                    <a href="admin.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Admin</a>
                    </li>
                    <?php endif; ?>
   ...
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <?php if(!isset($_SESSION['isloggedin']) || ($_SESSION['isloggedin'] == false)): ?>
         <li>
            <a href="about.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ml-3 whitespace-nowrap text-gray-700">About</span>
            </a>
         </li>
         <li>
            <a href="register.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ml-3 whitespace-nowrap text-gray-700">Sign In</span>
            </a>
         </li>
         <li>
            <a href="login.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ml-3 whitespace-nowrap text-gray-700">Login</span>
            </a>
         </li>
         <?php else: ?>
         <li>
            <a href="profile.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ml-3 whitespace-nowrap text-gray-700">Profile</span>
            </a>
         </li>
         <li>
            <a href="inbox.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ml-3 whitespace-nowrap text-gray-700">Inbox</span>
            </a>
         </li>
         <li>
            <a href="order.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ml-3 whitespace-nowrap text-gray-700">Order</span>
            </a>
         </li>
         <li>
            <a href="about.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
